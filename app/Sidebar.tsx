  ...
  const renderDrawerContent = () => (
    <View className="flex-1 bg-pink">
      ...
      <View className="absolute top-32 right-28">
        ...
        <Text className="mt-4 text-xl text-brown text-center">
      ...
      <View className="absolute top-[315px] left-24 flex-row items-center">
        <Image
            ...
            resizeMode="contain"
        />
        <Text className="ml-2 text-center text-xl text-brown">
            {currentStreak ?? 0}
        </Text>
        </View>

<Text className="absolute top-[345px] left-24 text-xl text-brown">
  streak
</Text>
      ...
      <View>
        <Image
          source={require("../figma-icons/diamond.png")}
          className="absolute top-[315px] right-36 w-7 h-7"
          resizeMode="contain"
        />
        <Text className="absolute top-[315px] right-24 text-xl text-brown">
          {gems ? gems : 0}
        </Text>
        <Text className="absolute top-[345px] right-24 text-xl text-brown">
          gems
        </Text>
      </View>
      ...
      <View className="p-4 gap-4 absolute">
        {/* Profile */}
        <TouchableOpacity
          className="top-[390px] flex-row items-center"
        ...
        {/* Friends */}
        <TouchableOpacity
          className="top-[390px] left-2 flex-row items-center"
        ...
        >
          <Image
            ...
            className="w-12 h-12"
          />
          <Text className="left-5 font-bold text-2xl text-brown">
            Leaderboard
          </Text>
        </TouchableOpacity>
  ...
  return (
    ...
    >
      ...
      <View className="flex-1 overflow-visible">
        ...
        <TouchableOpacity onPress={() => setOpen(true)} style={{ zIndex: 70 }}>
          <Image
            source={require("../figma-icons/sidebar.png")}
            className="absolute top-20 right-8 w-6 h-6"
            style={{ zIndex: 70 }}
          />
        </TouchableOpacity>
      </View>
